...
public class NotGuesser implements Guesser {
	...
	public Guess makeGuess(Trivia trivia) throws IOException {
		SearchResponse searchResponse1 = new TextSearcher().search(trivia.getQuestion(), trivia.getAnswer1());
		SearchResponse searchResponse2 = new TextSearcher().search(trivia.getQuestion(), trivia.getAnswer2());
		SearchResponse searchResponse3 = new TextSearcher().search(trivia.getQuestion(), trivia.getAnswer3());
